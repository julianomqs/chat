...
export class Migration20250220015404 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `create table \`chat_message\` (\`id\` int unsigned not null auto_increment primary key, \`date_time\` datetime not null, \`message\` varchar(500) not null, \`sender\` varchar(20) not null, \`receiver\` varchar(20) null, \`room_id\` int unsigned not null) default character set utf8mb4 engine = InnoDB;`
    );
    this.addSql(
